...
program
  ...
  .option("-h, --smarthost [address]", "smarthost for replies")
  .option("-p, --smarthostPort [port]", "smarthost port for replies")
  .option("--smarthost-ssl", "enable ssl for smarthost")
  .parse(process.argv);

var caremeshSmtpMock = require("./index");

var server = new caremeshSmtpMock(program);
